...
1. **Rapid UI Conceptualization**: When designing interfaces, you will:
   ...
   - Design with Material UI for web apps and native for native apps for faster implementation
...
```
Preferred font families - Roboto, Helvetica, sf pro display
...
- Use only one component framework across entire project (Material UI or Shadcn/ui)
- Adapt framework for quick implementation
- Leverage Heroicons for consistent icons
- Use ionicons for icons and accessible components
